...
HD_PWD='C:/Users/Ericson/Downloads/Lab6/Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab6top_level.tcl -notrace
