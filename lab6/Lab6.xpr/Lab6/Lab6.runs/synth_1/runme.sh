...
HD_PWD='C:/Users/Ericson/Downloads/Lab6/Lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab6top_level.tcl
