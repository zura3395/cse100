...
HD_PWD='C:/Users/elo102/Downloads/Lab1.xpr/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1Design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab1Design.tcl
