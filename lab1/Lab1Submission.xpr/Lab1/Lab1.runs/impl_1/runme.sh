...
HD_PWD='C:/Users/elo102/Downloads/Lab1.xpr/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1Design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab1Design.tcl -notrace
